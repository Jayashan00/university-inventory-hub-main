...
// Import University Logo (Optional - if you added it to assets)
// import uojLogo from '@/assets/images/uoj_logo.png';
...
const Login: React.FC = () => {
  ...
  const [quickLoginRole, setQuickLoginRole] = useState<UserRole | ''>('');
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg">
                {/* Replaced Icon with Graduation Cap, or use <img src={uojLogo} /> here */}
          ...
          <Card className="border-border/50 shadow-xl bg-card/50 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <div className="space-y-3 bg-muted/30 p-4 rounded-xl border border-border/50">
                ...
                <Select value={quickLoginRole} onValueChange={(v) => setQuickLoginRole(v as UserRole)}>
